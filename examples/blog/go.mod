...
// The templ generator writes the Go file of each .templ file. `avero generate`
// and `avero dev` run it, so a person needs no second tool.
tool github.com/a-h/templ/cmd/templ

replace github.com/alternayte/avero => ../..
